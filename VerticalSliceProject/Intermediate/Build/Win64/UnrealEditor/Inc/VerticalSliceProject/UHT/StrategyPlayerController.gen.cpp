...
VERTICALSLICEPROJECT_API UClass* Z_Construct_UClass_AStrategyPlayerController();
VERTICALSLICEPROJECT_API UClass* Z_Construct_UClass_AStrategyPlayerController_NoRegister();
VERTICALSLICEPROJECT_API UClass* Z_Construct_UClass_AStrategyUnit_NoRegister();
VERTICALSLICEPROJECT_API UEnum* Z_Construct_UEnum_VerticalSliceProject_EStrategyInputMode();
...
static UEnum* EStrategyInputMode_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_EStrategyInputMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_VerticalSliceProject_EStrategyInputMode, (UObject*)Z_Construct_UPackage__Script_VerticalSliceProject(), TEXT("EStrategyInputMode"));
	}
	return Z_Registration_Info_UEnum_EStrategyInputMode.OuterSingleton;
}
template<> VERTICALSLICEPROJECT_API UEnum* StaticEnum<EStrategyInputMode>()
{
	return EStrategyInputMode_StaticEnum();
}
struct Z_Construct_UEnum_VerticalSliceProject_EStrategyInputMode_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_VerticalSliceProject_EStrategyInputMode_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_VerticalSliceProject,
	nullptr,
	"EStrategyInputMode",
	"EStrategyInputMode",
	Z_Construct_UEnum_VerticalSliceProject_EStrategyInputMode_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_VerticalSliceProject_EStrategyInputMode_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::Regular,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_VerticalSliceProject_EStrategyInputMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_VerticalSliceProject_EStrategyInputMode_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_VerticalSliceProject_EStrategyInputMode()
{
	if (!Z_Registration_Info_UEnum_EStrategyInputMode.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EStrategyInputMode.InnerSingleton, Z_Construct_UEnum_VerticalSliceProject_EStrategyInputMode_Statics::EnumParams);
	}
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_AStrategyPlayerController_Statics::NewProp_InputMode = { "InputMode", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStrategyPlayerController, InputMode), Z_Construct_UEnum_VerticalSliceProject_EStrategyInputMode, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InputMode_MetaData), NewProp_InputMode_MetaData) }; // 3247303164
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_VerticalSliceProject_Source_VerticalSliceProject_Variant_Strategy_StrategyPlayerController_h__Script_VerticalSliceProject_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EStrategyInputMode_StaticEnum, TEXT("EStrategyInputMode"), &Z_Registration_Info_UEnum_EStrategyInputMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3247303164U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AStrategyPlayerController, AStrategyPlayerController::StaticClass, TEXT("AStrategyPlayerController"), &Z_Registration_Info_UClass_AStrategyPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AStrategyPlayerController), 474852642U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VerticalSliceProject_Source_VerticalSliceProject_Variant_Strategy_StrategyPlayerController_h__Script_VerticalSliceProject_3353150742(TEXT("/Script/VerticalSliceProject"),
	Z_CompiledInDeferFile_FID_VerticalSliceProject_Source_VerticalSliceProject_Variant_Strategy_StrategyPlayerController_h__Script_VerticalSliceProject_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_VerticalSliceProject_Source_VerticalSliceProject_Variant_Strategy_StrategyPlayerController_h__Script_VerticalSliceProject_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_VerticalSliceProject_Source_VerticalSliceProject_Variant_Strategy_StrategyPlayerController_h__Script_VerticalSliceProject_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_VerticalSliceProject_Source_VerticalSliceProject_Variant_Strategy_StrategyPlayerController_h__Script_VerticalSliceProject_Statics::EnumInfo));
// ********** End Registration *********************************************************************
